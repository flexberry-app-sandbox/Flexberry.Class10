...
namespace IIS.Class10
{
    ...
    [View("КомнатаE", new string[] {
            "Номер as \'Номер\'",
            "Дом as \'Дом\'",
            "Дом.НомерДома as \'Номер дома\'"}, Hidden=new string[] {
            "Дом.НомерДома"})]
    [MasterViewDefineAttribute("КомнатаE", "Дом", ICSSoft.STORMNET.LookupTypeEnum.Standard, "", "НомерДома")]
    [View("КомнатаL", new string[] {
            "Номер as \'Номер\'",
            "Дом.НомерДома as \'Номер дома\'"})]
    public class Комната : ICSSoft.STORMNET.DataObject
    {
        
        private int fНомер;
        
        private IIS.Class10.Дом fДом;
        ...
        [PropertyStorage(new string[] {
                "Дом"})]
        [NotNull()]
        public virtual IIS.Class10.Дом Дом
        {
            get
            {
                ...
                IIS.Class10.Дом result = this.fДом;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View КомнатаE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("КомнатаE", typeof(IIS.Class10.Комната));
                }
            }
            ...
            public static ICSSoft.STORMNET.View КомнатаL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("КомнатаL", typeof(IIS.Class10.Комната));
                }
            }
        }
    }
