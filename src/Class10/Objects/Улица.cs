...
namespace IIS.Class10
{
    ...
    public class Улица : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Class10.Город fГород;
        ...
        [PropertyStorage(new string[] {
                "Город"})]
        [NotNull()]
        public virtual IIS.Class10.Город Город
        {
            get
            {
                ...
                IIS.Class10.Город result = this.fГород;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View УлицаE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("УлицаE", typeof(IIS.Class10.Улица));
                }
            }
            ...
            public static ICSSoft.STORMNET.View УлицаL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("УлицаL", typeof(IIS.Class10.Улица));
                }
            }
        }
    }
