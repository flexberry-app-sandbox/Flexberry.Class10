...
namespace IIS.Class10
{
    ...
    [View("ДомE", new string[] {
            ...
            "Улица as \'Улица\'",
            "Улица.ИмяУлицы as \'Имя улицы\'"}, Hidden=new string[] {
            "Улица.ИмяУлицы"})]
    [MasterViewDefineAttribute("ДомE", "Улица", ICSSoft.STORMNET.LookupTypeEnum.Standard, "", "ИмяУлицы")]
    [View("ДомL", new string[] {
            "НомерДома as \'Номер дома\'",
            "Улица.ИмяУлицы as \'Имя улицы\'"})]
    public class Дом : ICSSoft.STORMNET.DataObject
    {
        
        private int fНомерДома;
        
        private IIS.Class10.Улица fУлица;
        ...
        [PropertyStorage(new string[] {
                "Улица"})]
        [NotNull()]
        public virtual IIS.Class10.Улица Улица
        {
            get
            {
                ...
                IIS.Class10.Улица result = this.fУлица;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ДомE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ДомE", typeof(IIS.Class10.Дом));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ДомL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ДомL", typeof(IIS.Class10.Дом));
                }
            }
        }
    }
